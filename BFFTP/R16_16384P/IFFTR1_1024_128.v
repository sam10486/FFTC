...
//      version:		2008Q2V2
//      comment:		
//      configuration:	 -instname "IFFTR1_1024_128" -words 1024 -bits 128 -frequency 200 -ring_width 6.0 -code_file "R16_IFFTROM1.txt" -mux 8 -top_layer "met5-9" -power_type rings -horiz met3 -vert met4 -bmux off -ema off -cust_comment "" -bus_notation on -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND -drive 6 -asvm off -corners ff_1.1_-40.0,tt_1.0_25.0,ss_0.9_125.0,ff_1.1_125.0
//
//      Verilog model for Synchronous Single-Port Rom
//
//      Instance Name:              IFFTR1_1024_128
//      Words:                      1024
//      Bits:                       128
//      Mux:                        8
//      Drive:                      6
...
//      Test Muxes                  Off
//
//      Creation Date:  2022-11-21 13:29:16Z
//      Version: 	2008Q2V2
//
...
`celldefine
  module IFFTR1_1024_128 (
   ...
   initial 
     begin
	$readmemb("IFFTR1_1024_128_verilog.rcf", mem );
	adjust_mem;
     end
